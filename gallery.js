...
const SAMPLES = {
  ...
  fixtures: {
    ...
    list: [
      ...
      `بايرن | دورتموند | البوندسليغا | 8:30 م | ${L(T.bay)} | ${L(T.dor)}`,
      `يوفنتوس | إنتر | السيري آ | 10:45 م | ${L(T.juv)} | ${L(T.int)}`,
    ].join('\n'),
  },
  results: {
    ...
    list: [
      ...
      `بايرن | دورتموند | 4 - 0 | البوندسليغا | ${L(T.bay)} | ${L(T.dor)}`,
      `يوفنتوس | إنتر | 2 - 2 | السيري آ | ${L(T.juv)} | ${L(T.int)}`,
    ].join('\n'),
  },
};
